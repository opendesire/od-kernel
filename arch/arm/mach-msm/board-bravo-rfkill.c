...
static uint32_t bravo_bt_init_table[] = {
	/* BT_RTS */
	PCOM_GPIO_CFG(BRAVO_GPIO_BT_UART1_RTS,
				0,
				GPIO_OUTPUT,
				GPIO_NO_PULL,
				GPIO_8MA),
	/* BT_CTS */
	PCOM_GPIO_CFG(BRAVO_GPIO_BT_UART1_CTS,
				0,
				GPIO_INPUT,
				GPIO_PULL_UP,
				GPIO_8MA),
	/* BT_RX */
	PCOM_GPIO_CFG(BRAVO_GPIO_BT_UART1_RX,
				0,
				GPIO_INPUT,
				GPIO_PULL_UP,
				GPIO_8MA),
	/* BT_TX */
	PCOM_GPIO_CFG(BRAVO_GPIO_BT_UART1_TX,
				0,
				GPIO_OUTPUT,
				GPIO_NO_PULL,
				GPIO_8MA),
	...
	/* BT_SHUTDOWN_N */
	PCOM_GPIO_CFG(BRAVO_GPIO_BT_SHUTDOWN_N,
				0,
				GPIO_OUTPUT,
				GPIO_NO_PULL,
				GPIO_4MA),
	/* BT_RESET_N */
	PCOM_GPIO_CFG(BRAVO_GPIO_BT_RESET_N,
				0,
				GPIO_OUTPUT,
				GPIO_NO_PULL,
				GPIO_4MA),
	...
	/* BT_HOST_WAKE */
	PCOM_GPIO_CFG(BRAVO_GPIO_BT_HOST_WAKE,
				0,
				GPIO_INPUT,
				GPIO_PULL_UP,
				GPIO_4MA),
	/* BT_CHIP_WAKE */
	PCOM_GPIO_CFG(BRAVO_GPIO_BT_WAKE,
				0,
				GPIO_OUTPUT,
				GPIO_NO_PULL,
				GPIO_4MA),
...
static void bravo_config_bt_init(void)
{
	...
	/* BT_RTS */
        gpio_direction_output(BRAVO_GPIO_BT_UART1_RTS, 0);

	/* BT_TX */
        gpio_direction_output(BRAVO_GPIO_BT_UART1_TX, 0);

	/* BT_CHIP_WAKE */
        gpio_direction_output(BRAVO_GPIO_BT_WAKE, 0);
...
static void bravo_config_bt_on(void)
{
	...
	/* BT_CHIP_WAKE */
        gpio_direction_output(BRAVO_GPIO_BT_WAKE, 1);
